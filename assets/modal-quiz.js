(() => {
  ...
  var define = (name15) => (render2) => () => {
    class HalogenElement extends HTMLElement {
      connectedCallback() {
        render2(this)();
      }
    }
    customElements.define(name15, HalogenElement);
  };
  ...
  var takeWhile = function(p2) {
    return function(s) {
      return take2(countPrefix2(p2)(s))(s);
    };
  };
  ...
  var map9 = /* @__PURE__ */ map(functorCoyoneda);
  ...
  var unsubscribe3 = function(sid) {
    return function(ref2) {
      return function __do2() {
        ...
        return traverse_4(unsubscribe)(bindFlipped4(lookup4(sid))(subs))();
      };
    };
  };
  ...
  var evalQ = function(render2) {
    return function(ref2) {
      return function(q2) {
        return bind12(liftEffect3(read(ref2)))(function(v) {
          return evalM(render2)(ref2)(v["component"]["eval"](new Query(map9(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
        ...
        var go2 = function(ref2) {
          return function(v1) {
            ...
            if (v1 instanceof Raise) {
              return bind12(liftEffect3(read(ref2)))(function(v2) {
                return bind12(liftEffect3(read(v2.handlerRef)))(function(handler2) {
                ...
                return bind12(liftEffect3(read(ref2)))(function(v2) {
                  return bind12(liftEffect3($$new(false)))(function(doneRef) {
                    return bind12(fork3($$finally(liftEffect3(function __do2() {
                      ...
                      return discard1(liftEffect3(unlessM2(read(doneRef))(modify_2(insert1(fid)(fiber))(v2.forks))))(function() {
      ...
      return function(i2) {
            ...
            return function(childrenInRef) {
              return function(childrenOutRef) {
                return unComponentSlot(function(slot) {
                  return function __do2() {
                    var childrenIn = map10(slot.pop)(read(childrenInRef))();
                    var $$var2 = function() {
                    ...
                    var isDuplicate = map10(function($69) {
        ...
        var render2 = function(lchs) {
          return function($$var2) {
            return function __do2() {
              var v = read($$var2)();
              var shouldProcessHandlers = map10(isNothing)(read(v.pendingHandlers))();
  ...
  var runUI2 = function(component) {
    return function(i2) {
      return function(element3) {
        return bind14(liftEffect5(map14(toDocument)(bindFlipped6(document)(windowImpl))))(function(document2) {
  ...
  var runParserT = function(dictMonadRec) {
    ...
    return function(s) {
      return function(p2) {
        ...
        return map18(fst)(runParserT$prime1(initialState)(p2));
      };
    };
  };
  ...
  var withErrorMessage = function(p2) {
    return function(msg) {
      return alt5(p2)(fail("Expected " + msg));
    };
  };
    ...
    return function(sep) {
      var go2 = function(acc) {
        var done = defer4(function(v) {
          return pure8(new Done(reverse2(acc)));
        });
      ...
      return bind4(p2)(function(a2) {
        return alt5(map15(cons$prime(a2))(tailRecM4(go2)(Nil.value)))(pure8(singleton6(a2)));
      });
    };
  };
  ...
  var termP = function(prefixP) {
    return function(term) {
      return function(postfixP) {
        return bind5(prefixP)(function(pre2) {
          return bind5(term)(function(x) {
            return bind5(postfixP)(function(post) {
              return pure9(post(pre2(x)));
            });
          });
        });
      };
  ...
  var rassocP1 = function(x) {
    return function(rassocOp) {
      return function(prefixP) {
        return function(term) {
          return function(postfixP) {
            return alt6(rassocP(x)(rassocOp)(prefixP)(term)(postfixP))(pure9(x));
          };
        };
      };
    };
        ...
        return function(term) {
          return function(postfixP) {
            return bind5(nassocOp)(function(f) {
              return bind5(termP(prefixP)(term)(postfixP))(function(y) {
                return pure9(f(x)(y));
              });
            });
          };
  ...
  var lassocP1 = function(x) {
    return function(lassocOp) {
      return function(prefixP) {
        return function(term) {
          return function(postfixP) {
            return alt6(lassocP(x)(lassocOp)(prefixP)(term)(postfixP))(pure9(x));
          };
        };
      };
    };
  ...
  var makeParser = function(term) {
    return function(ops) {
      ...
      var postfixP = alt6(postfixOp)(pure9(identity8));
      var prefixOp = withErrorMessage(choice2(accum.prefix))("");
      var prefixP = alt6(prefixOp)(pure9(identity8));
      var rassocOp = choice2(accum.rassoc);
      return bind5(termP(prefixP)(term)(postfixP))(function(x) {
        return alt6(rassocP(x)(rassocOp)(prefixP)(term)(postfixP))(alt6(lassocP(x)(lassocOp)(prefixP)(term)(postfixP))(alt6(nassocP(x)(nassocOp)(prefixP)(term)(postfixP))(withErrorMessage(pure9(x))("operator"))));
      });
    };
  };
  ...
  var takeWhile1 = function(predicate) {
    return consumeWith(function(s) {
      ...
      var len = length2(value12);
      var $27 = len > 0;
      if ($27) {
        return new Right({
          consumed: value12,
          remainder: drop(length2(value12))(s),
          value: value12
        });
      }
      ;
  ...
  // output/Web.DOM.MutationRecord/foreign.js
  function target5(mr) {
    return function() {
      return mr.target;
    };
  }
  function _attributeName(mr) {
    return function() {
      return mr.attributeName;
    };
  }

  // output/Web.DOM.MutationRecord/index.js
  var map16 = /* @__PURE__ */ map(functorEffect);
  var attributeName = /* @__PURE__ */ function() {
    var $14 = map16(toMaybe);
    return function($15) {
      return $14(_attributeName($15));
    };
  }();
  ...
  var insert12 = /* @__PURE__ */ insert2(ordString);
  var delete1 = /* @__PURE__ */ $$delete2(ordString);
  ...
  var Overlay = /* @__PURE__ */ function() {
    function Overlay2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    Overlay2.create = function(value0) {
      return function(value1) {
        return new Overlay2(value0, value1);
      };
    };
    return Overlay2;
  }();
  var Connect = /* @__PURE__ */ function() {
    function Connect2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    Connect2.create = function(value0) {
      return function(value1) {
        return new Connect2(value0, value1);
      };
    };
    return Connect2;
  }();
  ...
  var LAnd = /* @__PURE__ */ function() {
    function LAnd2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    LAnd2.create = function(value0) {
      return function(value1) {
        return new LAnd2(value0, value1);
      };
    };
    return LAnd2;
  }();
  var LOr = /* @__PURE__ */ function() {
    function LOr2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    LOr2.create = function(value0) {
      return function(value1) {
        return new LOr2(value0, value1);
      };
    };
    return LOr2;
  }();
  var LTo = /* @__PURE__ */ function() {
    function LTo2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    LTo2.create = function(value0) {
      return function(value1) {
        return new LTo2(value0, value1);
      };
    };
    return LTo2;
  }();
  var Box = /* @__PURE__ */ function() {
    function Box2(value0) {
      this.value0 = value0;
    }
    ;
    Box2.create = function(value0) {
      return new Box2(value0);
    };
    return Box2;
  }();
  var Diamond = /* @__PURE__ */ function() {
    function Diamond2(value0) {
      this.value0 = value0;
    }
    ;
    Diamond2.create = function(value0) {
      return new Diamond2(value0);
    };
    return Diamond2;
  }();
  var NewModel = /* @__PURE__ */ function() {
    function NewModel2(value0) {
      this.value0 = value0;
    }
    ;
    NewModel2.create = function(value0) {
      return new NewModel2(value0);
    };
    return NewModel2;
  }();
  var NewProp = /* @__PURE__ */ function() {
    function NewProp2(value0) {
      this.value0 = value0;
    }
    ;
    NewProp2.create = function(value0) {
      return new NewProp2(value0);
    };
    return NewProp2;
  }();
  var RemoveProp = /* @__PURE__ */ function() {
    function RemoveProp2(value0) {
      this.value0 = value0;
    }
    ;
    RemoveProp2.create = function(value0) {
      return new RemoveProp2(value0);
    };
    return RemoveProp2;
  }();
  var NewFormula = /* @__PURE__ */ function() {
    function NewFormula2(value0) {
      this.value0 = value0;
    }
    ;
    NewFormula2.create = function(value0) {
      return new NewFormula2(value0);
    };
    return NewFormula2;
  }();
  var NewWorld = /* @__PURE__ */ function() {
    function NewWorld2(value0) {
      this.value0 = value0;
    }
    ;
    NewWorld2.create = function(value0) {
      return new NewWorld2(value0);
    };
    return NewWorld2;
  }();
  var RemoveWorld = /* @__PURE__ */ function() {
    function RemoveWorld2(value0) {
      this.value0 = value0;
    }
    ;
    RemoveWorld2.create = function(value0) {
      return new RemoveWorld2(value0);
    };
    return RemoveWorld2;
  }();
  ...
  var word = /* @__PURE__ */ takeWhile1(isAlpha);
  var updateTask = function(upd) {
    return function(t) {
      if (upd instanceof NewModel) {
        return {
          props: t.props,
          formula: t.formula,
          model: upd.value0
      ...
      ;
      if (upd instanceof NewProp) {
        return {
          model: t.model,
          formula: t.formula,
          props: insert6(upd.value0.name)(upd.value0.sat)(t.props)
        };
      }
      ;
      if (upd instanceof RemoveProp) {
        return {
          model: t.model,
          formula: t.formula,
          props: $$delete5(upd.value0)(t.props)
        };
      }
      ;
      if (upd instanceof NewFormula) {
        return {
          model: t.model,
          props: t.props,
          formula: upd.value0
      ...
      ;
      throw new Error("Failed pattern match at Main (line 115, column 20 - line 119, column 36): " + [upd.constructor.name]);
    };
  };
  var satParser = /* @__PURE__ */ map17(/* @__PURE__ */ fromFoldable(foldableNonEmptyList)(ordString))(/* @__PURE__ */ applySecond2(skipSpaces)(/* @__PURE__ */ sepEndBy1(word)(/* @__PURE__ */ applySecond2(/* @__PURE__ */ applySecond2(skipSpaces)(/* @__PURE__ */ $$char(",")))(skipSpaces))));
  var render = function(v) {
    return function(v1) {
      return div3([])([]);
    };
  };
  var modelParser = /* @__PURE__ */ function() {
    return buildExprParser([[new Infix(voidLeft4($$char("*"))(Connect.create), AssocRight.value)], [new Infix(voidLeft4($$char("+"))(Overlay.create), AssocRight.value)]])(map17(Single.create)(word));
  }();
  var handleAction = function(action2) {
    return modify_3(function(p2) {
      if (action2 instanceof NewWorld) {
        var $102 = {};
        for (var $103 in p2) {
          if ({}.hasOwnProperty.call(p2, $103)) {
            $102[$103] = p2[$103];
          }
          ;
        }
        ;
        $102.worlds = insert12(action2.value0)(p2.worlds);
        return $102;
      }
      ;
      if (action2 instanceof RemoveWorld) {
        var $106 = {};
        for (var $107 in p2) {
          if ({}.hasOwnProperty.call(p2, $107)) {
            $106[$107] = p2[$107];
          }
          ;
        }
        ;
        $106.worlds = delete1(action2.value0)(p2.worlds);
        return $106;
      }
      ;
      if (action2 instanceof Check) {
        var $110 = {};
        for (var $111 in p2) {
          if ({}.hasOwnProperty.call(p2, $111)) {
            $110[$111] = p2[$111];
          }
          ;
        }
      ...
      ;
      throw new Error("Failed pattern match at Main (line 146, column 41 - line 149, column 30): " + [action2.constructor.name]);
    });
  };
  var taskComponent = function(task) {
    return mkComponent({
      initialState: $$const({
        worlds: empty3,
        check: false
  ...
  var formulaParser = /* @__PURE__ */ function() {
    return buildExprParser([[new Prefix(voidLeft4(string("\\neg"))(Not.create)), new Prefix(voidLeft4(string("\\box"))(Box.create)), new Prefix(voidLeft4(string("\\Diamond"))(Diamond.create))], [new Infix(voidLeft4(string("\\land"))(LAnd.create), AssocRight.value)], [new Infix(voidLeft4(string("\\lor"))(LOr.create), AssocRight.value)], [new Infix(voidLeft4(string("\\to"))(LTo.create), AssocRight.value)]])(map17(Var.create)(word));
  }();
  var fromMutation = function(record) {
    return function __do2() {
      var node = target5(record)();
      var el = function() {
        var v3 = fromNode(node);
        if (v3 instanceof Just) {
          return v3.value0;
        }
        ;
        if (v3 instanceof Nothing) {
          return $$throw("target is not an element")();
        }
        ;
        throw new Error("Failed pattern match at Main (line 88, column 9 - line 90, column 58): " + [v3.constructor.name]);
      }();
      var v = attributeName(record)();
      if (v instanceof Just && v.value0 === "worlds") {
        var v1 = getAttribute(v.value0)(el)();
        if (v1 instanceof Just) {
          var v2 = runParser(v1.value0)(modelParser);
          if (v2 instanceof Left) {
            return $$throw(show3(v2.value0))();
          }
          ;
          if (v2 instanceof Right) {
            return new NewModel(v2.value0);
          }
          ;
          throw new Error("Failed pattern match at Main (line 93, column 22 - line 95, column 39): " + [v2.constructor.name]);
        }
        ;
        if (v1 instanceof Nothing) {
          return $$throw("worlds attribute is missing")();
        }
        ;
        throw new Error("Failed pattern match at Main (line 92, column 54 - line 96, column 63): " + [v1.constructor.name]);
      }
      ;
      if (v instanceof Just) {
        var v1 = getAttribute(v.value0)(el)();
        if (v1 instanceof Just) {
          var v2 = runParser(v1.value0)(satParser);
          if (v2 instanceof Left) {
            return $$throw(show3(v2.value0))();
          }
          ;
          ...
          ;
          throw new Error("Failed pattern match at Main (line 98, column 22 - line 100, column 50): " + [v2.constructor.name]);
        }
        ;
        if (v1 instanceof Nothing) {
          return new RemoveProp(v.value0);
        }
        ;
        throw new Error("Failed pattern match at Main (line 97, column 45 - line 101, column 40): " + [v1.constructor.name]);
      }
      ;
      if (v instanceof Nothing) {
        var formula = textContent(node)();
        var v1 = runParser(formula)(formulaParser);
        if (v1 instanceof Left) {
          return $$throw(show3(v1.value0))();
        }
        ;
        if (v1 instanceof Right) {
          return new NewFormula(v1.value0);
        }
        ;
        throw new Error("Failed pattern match at Main (line 104, column 7 - line 106, column 41): " + [v1.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Main (line 91, column 31 - line 106, column 41): " + [v.constructor.name]);
    };
  };
  var eqModel = {
    eq: function(x) {
      return function(y) {
        ...
        if (x instanceof Overlay && y instanceof Overlay) {
          return eq(eqModel)(x.value0)(y.value0) && eq(eqModel)(x.value1)(y.value1);
        }
        ;
    ...
    eq: function(x) {
      return function(y) {
        ...
        if (x instanceof Not && y instanceof Not) {
          return eq(eqFormula)(x.value0)(y.value0);
        }
        ;
        if (x instanceof LAnd && y instanceof LAnd) {
          return eq(eqFormula)(x.value0)(y.value0) && eq(eqFormula)(x.value1)(y.value1);
        }
        ;
        if (x instanceof LOr && y instanceof LOr) {
          return eq(eqFormula)(x.value0)(y.value0) && eq(eqFormula)(x.value1)(y.value1);
        }
        ;
        if (x instanceof LTo && y instanceof LTo) {
          return eq(eqFormula)(x.value0)(y.value0) && eq(eqFormula)(x.value1)(y.value1);
        }
        ;
        if (x instanceof Box && y instanceof Box) {
          return eq(eqFormula)(x.value0)(y.value0);
        }
        ;
  ...
  var notEq2 = /* @__PURE__ */ notEq(/* @__PURE__ */ eqRec()(/* @__PURE__ */ eqRowCons(/* @__PURE__ */ eqRowCons(/* @__PURE__ */ eqRowCons(eqRowNil)()({
    reflectSymbol: function() {
      return "props";
    }
  })(/* @__PURE__ */ eqMap(eqString)(/* @__PURE__ */ eqSet(eqString))))()({
    reflectSymbol: function() {
      return "model";
    }
  })(eqModel))()({
  ...
  var runTaskComponent = function(el) {
    return function(ref2) {
      return function(records) {
        return function __do2() {
          var updates = traverse2(fromMutation)(records)();
          var v = flip(modify$prime)(ref2)(function(oldTask) {
            var newTask = foldr2(updateTask)(oldTask)(updates);
            return {
              state: newTask,
              value: {
                oldTask,
          ...
          var $166 = notEq2(v.newTask)(v.oldTask);
          if ($166) {
            return runHalogenAff(runUI2(taskComponent(v.newTask))(unit)(el))();
          }
          ;
          return unit;
        };
  ...
  var main2 = /* @__PURE__ */ define("modal-task")(function(el) {
    return function __do2() {
      var ref2 = $$new({
        model: new Single("EMPTY"),
        props: empty2,
        formula: new Var("EMPTY")
      })();
      var observer = mutationObserver(function(records) {
        return function(v) {
          return runTaskComponent(el)(ref2)(records);
        };
      })();
      observe2(toNode(el))({
        attributes: true,
      ...
      return bind6(takeRecords(observer))(runTaskComponent(el)(ref2))();
    };
  });
