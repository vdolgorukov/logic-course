...
> ##### Упражнение. Запишите следующие высказывания на языке логике предикатов, используя следующие обозначания:
> - $a$ – "Аня"
> - $b$ – "Боря"
> - $c$ – "Сережа"
> - $P$ – "быть умным" 
...
:green_book: **Упражнение (с ответами)**. Запишите следующие высказывания на языке логике предикатов, используя следующие обозначания:
- $a$ – "Аня"
- $b$ – "Боря"
- $c$ – "Сережа"
- $P$ – "быть умным" 
